...
// Login permite el login del usuario
...
// UserCreate permite crear usuarios
func UserCreate(w http.ResponseWriter, r *http.Request) {
	...
	pictureStr := fmt.Sprintf("%x", pictureMd5)
	user.Picture = "https://gravatar.com/avatar/" + pictureStr + "?s=100"
