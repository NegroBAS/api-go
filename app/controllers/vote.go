...
// VoteRegister controlador para registrar votos
...
// updateCommentVotes actuliza la cantidad de votos en la tabla de Datos
// isUpdate indica si es una actualizacion de voto
func updateCommentVotes(commentID uint, vote bool, isUpdate bool) (err error) {
	...
	if rows > 0 {
		...
		err = errors.New("No se encontro un registro de commentario para asignarle el voto")
	}
	return
}
